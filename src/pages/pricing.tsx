...
export default function PricingPage() {
  return (
    <Layout title="Headshot Photography Pricing | Judy Babinski Photography" description="Headshot session pricing for Detroit Metro. Extended and Express studio sessions starting at $200.">
